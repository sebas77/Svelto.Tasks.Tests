...
namespace LoadingPipeline
{
    internal static class Program
    {
        ...
        private static void Main()
        {
            ...
            Console.WriteLine("  │  💡 yield return cfg → parent reads child.Current.ToRef<T>()  │");
            Console.WriteLine("  └──────────────────────────────────────────────────────────────┘");
            Console.WriteLine();
        }

        private static void DrawProgress(int pct, string status)
        {
            int barLen = 20;
        ...
        private static void DrawResult(GameConfig cfg)
        {
            SafeSetCursor(0, 12);
            Console.WriteLine("  ╔═══════════════════════════════════════════════════════════════╗");
        ...
        private static void PrintBanner()
        {
            ...
            Console.WriteLine("  ║  to the parent via `yield return cfg`. Parent reads it with  ║");
            ...
            Console.WriteLine("                 CHILD: yield return cfg;     (return value)");
