...
namespace BackgroundComputation
{
    internal static class Program
    {
        ...
        private static volatile int _bgProgress;
        private static volatile int _bgResult = -1;
        private static volatile bool _bgDone;
        ...
        private static void DrawPanels(char spinner, int bgPct, bool bgDone, int bgResult, bool final = false)
        {
            int barLen = 16;
